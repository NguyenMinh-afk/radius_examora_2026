  ...
  const sections: Section[] = [
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <p>
            Welcome to EXAMORA ("we," "us," or "our"). By accessing or using our AI-powered examination platform and related services (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). Please read these Terms carefully before using our Services.
          </p>
          <p>
            These Terms constitute a legally binding agreement between you and EXAMORA regarding your use of the Services. If you do not agree to these Terms, you may not access or use the Services.
          </p>
      ...
      content: (
        <div className="space-y-3 text-gray-600">
          ...
          <ul className="space-y-2 ml-4">
            <li><strong>"Account"</strong> – Your registered user account on the EXAMORA platform.</li>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <p>EXAMORA provides an AI-powered examination platform that includes:</p>
          <ul className="space-y-2 ml-4">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          ...
          <p>
            You grant EXAMORA a non-exclusive, worldwide, royalty-free license to use your Content for: operating and improving our Services, generating AI-powered features, and ensuring the security and integrity of the platform.
          </p>
          
          <h4 className={`font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>6.3 Platform Intellectual Property</h4>
          <p>
            EXAMORA and its licensors own all rights, title, and interest in the Services, including but not limited to: the platform software, AI models, algorithms, user interfaces, designs, and trademarks. You may not use our intellectual property without prior written consent.
          </p>
          
          <h4 className={`font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>6.4 AI-Generated Content</h4>
          <p>
            Questions and content generated by our AI are provided for educational purposes. While we strive for accuracy, EXAMORA does not guarantee the correctness or appropriateness of AI-generated content. Educators should review all AI-generated material before use.
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          ...
          <p>
            EXAMORA offers various subscription plans for different user tiers. Pricing and features are described on our pricing page and are subject to change with 30 days' notice.
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, EXAMORA AND ITS AFFILIATES SHALL NOT BE LIABLE FOR:
          </p>
          <ul className="space-y-1 ml-4">
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          ...
          <div className={`${isDark ? "bg-slate-700" : "bg-gray-50"} rounded-xl p-6 space-y-3`}>
            <div>
              <strong className={isDark ? "text-white" : "text-gray-900"}>EXAMORA Legal Department</strong>
            </div>
            <div>Email: legal@EXAMORA.ai</div>
            <div>Address: Hanoi, Vietnam</div>
            <div>Website: www.EXAMORA.ai</div>
          </div>
          <p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <p className={`text-lg ${isDark ? "text-gray-400" : "text-gray-600"} max-w-2xl mx-auto`}>
              These terms govern your use of EXAMORA's AI-powered examination platform. Please read carefully.
            </p>
          </div>
