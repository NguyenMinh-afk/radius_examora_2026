...
const Terms: React.FC = () => {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <h4 className="font-semibold text-gray-900">3.1 Eligibility</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">3.2 Account Information</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">3.3 Account Security</h4>
          <p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <h4 className="font-semibold text-gray-900">5.1 Permitted Uses</h4>
          ...
          <h4 className="font-semibold text-gray-900">5.2 Prohibited Activities</h4>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <h4 className="font-semibold text-gray-900">6.1 Ownership</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">6.2 License to User Content</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">6.3 Platform Intellectual Property</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">6.4 AI-Generated Content</h4>
          <p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <h4 className="font-semibold text-gray-900">8.1 Subscription Plans</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">8.2 Billing</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">8.3 Free Tier</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">8.4 Taxes</h4>
          <p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <h4 className="font-semibold text-gray-900">9.1 "As Is" Basis</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">9.2 No Guarantee of Results</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">9.3 Third-Party Content</h4>
          <p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <h4 className="font-semibold text-gray-900">11.1 Termination by You</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">11.2 Termination by Us</h4>
          <p>
          ...
          <h4 className="font-semibold text-gray-900">11.3 Effect of Termination</h4>
          <p>
      ...
      content: (
        <div className="space-y-4 text-gray-600 leading-relaxed">
          ...
          <div className="bg-gray-50 rounded-xl p-6 space-y-3">
            <div>
              <strong className="text-gray-900">EXMORA Legal Department</strong>
            </div>
