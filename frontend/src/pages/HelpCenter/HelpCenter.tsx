          ...
          <div className="grid lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                ...
                <div className="space-y-2">
                  <a href="/terms" className="flex items-center justify-between px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">
                    Điều khoản sử dụng
                    <ExternalLink size={14} className="text-gray-400" />
                  </a>
                  <a href="/privacy" className="flex items-center justify-between px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">
                    Chính sách bảo mật
                    <ExternalLink size={14} className="text-gray-400" />
                  </a>
                </div>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                <h3 className="font-semibold text-amber-800 mb-2">Bạn vẫn cần hỗ trợ?</h3>
