          ...
          return (
            ...
            >
              ...
              <div className="text-left">
                <p className={`text-sm font-medium ${isActive ? (isDark ? "text-purple-200" : "text-purple-700") : (isDark ? "text-white" : "text-slate-900")}`}>{t.label}</p>
                <p className={`text-xs ${isActive ? (isDark ? "text-purple-300/80" : "text-purple-600/80") : (isDark ? "text-gray-400" : "text-slate-500")}`}>{t.desc}</p>
              </div>
              {isActive && (
