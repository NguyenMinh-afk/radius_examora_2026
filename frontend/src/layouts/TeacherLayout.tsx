  ...
  return (
    <div className={`flex h-screen ${isDark ? "bg-slate-950" : "bg-slate-50"}`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Cohesive Header */}
        <header className={`px-4 lg:px-6 py-3 flex items-center justify-between border-b ${
          isDark
        ...
        {/* Page Content */}
        <main className={`flex-1 overflow-y-auto px-4 lg:px-6 py-4 lg:py-6 ${isDark ? "text-white" : "text-slate-900"}`}>
          <Outlet />
        </main>
      </div>
    </div>
