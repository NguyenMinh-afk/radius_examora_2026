-- =====================================================
-- INITDB 07: Infrastructure Eventing (infra_eventing)
...
--   - Infrastructure_Service/tests/...
-- Each (consumer_name, message_id) pair is unique.
-- =====================================================
...
-- =====================================================
-- Consumed by:
--   - Infrastructure_Service/src/workers/outbox.worker.js (retry-exhausted insert)
-- =====================================================
